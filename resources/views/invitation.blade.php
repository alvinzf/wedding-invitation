...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('assets/invitation/theme/theme_40/assets/css/vendor.css?v=4224221d5224d8d4ea99f99574a5bb453ef2a2d8') }}">

    <link rel="stylesheet"
        href="{{ asset('assets/invitation/theme/theme_79/assets/css/styles.css?v=9ad0c73438b45a8f4a4c849946fd33306a8b92ce') }}">

    <link rel="stylesheet"
        href="{{ asset('assets/invitation/theme/assets/css/gift_registry.css?v=657207515c1330cf2fbecf68a819b37584123712') }}">
...
<body>
        ...
        <section class="cover-section">
            <div class="elements-wrapper-absolute">
                <div class="background-element">
                    <img src="{{ asset('assets/undangan/images/background.webp') }}" alt="bg-art" width="1440"
                        height="810">
                </div>
            </div>
                ...
                <div class="elements-absolute">
                    <div class="background-element">
                        <div class="background-wrapper">
                            <img src="{{ asset('assets/undangan/images/background.webp') }}" alt="bg-town"
                                    ...
                                    <div class="col-md-5 col-12">
                                        <div class="header">
                                            <div class="header-title" data-anim="fade-down" data-anim-delay="1500">
                                                ...
                                                <div>
                                                    <p><span style="font-size: 12pt;">Dan di antara tanda-tanda
                                                            (kebesaran)-Nya ialah Dia menciptakan pasangan-pasangan
                                                            untukmu dari jenismu sendiri, agar kamu cenderung dan merasa
                                                            tenteram kepadanya, dan Dia menjadikan di antaramu rasa
                                                            kasih dan sayang. Sungguh, pada yang demikian itu
                                                            benar-benar terdapat tanda-tanda bagi kaum yang berpikir
                                                        </span></p>
                                                </div>
                                                <div>
                                                    <p><span style="font-size: 12pt;"><strong> QS. Ar-Rum: 21
                                                            </strong></span></p>
                                                </div>
                                            </div>
                                            <div class="scroll-icon">
                                                <svg data-anim="slide-down" width="28" height="42"
                                                    viewBox="0 0 28 42" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <rect opacity="0.6" x="0.5" y="0.5" width="27"
                                                        height="41" rx="13.5" stroke="#757346" />
                                                    <rect id="scroll-animate" opacity="0.6" x="12" y="6.66699"
                                                        width="4" height="9.33333" rx="2"
                                                        fill="#A79E74" />
                                                </svg>
                                            </div>
                                        </div>
                            ...
                            <div class="couple" data-anim="fade-down">
                                ...
                                <div class="couple-description" data-anim="zoom-in">
                                    ...
                                    <div class="sosmed-wrap mt-3">
                                        <a href="https://instagram.com/redinathara" class="sosmed notranslate"
                        ...
                        <div class="col-md-6 col-xl-5 position-relative">
                            ...
                            <div class="couple" data-anim="fade-down">
                                ...
                                <div class="couple-description" data-anim="zoom-in">
                                    ...
                                    <div class="sosmed-wrap mt-3">
                                        <a href="https://instagram.com/alvinzulham" class="sosmed notranslate"
                                            target="_blank" rel="noopener noreferrer">
            ...
            <section class="moveable-section" data-id="4">
                ...
                <div class="venue-section">
                    <div class="position-relative">
                        <div class="elements-wrapper-absolute">
                            <div class="background-element">
                                <img src="{{ asset('assets/undangan/images/background.webp') }}" alt="bg-art"
                                    width="1440" height="810">
                            </div>
                            <div class="overlay-elements-gradient overlay-top"></div>
                            <div class="overlay-elements-gradient overlay-bottom"></div>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="widget-wrapper" data-anim="zoom-in">
                                                                    <a class="btn btn-custom mt-3"
                                                                        aria-label="button maps" href="#"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#event7032">Lokasi</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div id="cardRSVP" style="display: none">
                                                <div class="card" id="card">
                                                    ...
                                                    <div class="important">
                                                        ...
                                                        <p>Silakan sebutkan kode atau tunjukkan QRCode berikut kepada
                                                ...
                                                <div class="card" id="card">
                                                    <div class="col-md-12 d-flex justify-content-center">
                                                        <button
                                                            class="btn btn-custom color-secondary w-100 has-animate"
                                                            id="download-btn">Download RSVP Card</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="formRSVP">
                                                ...
                                                <form id="rsvpdata" data-anim="fade" data-anim-delay="500">
                                                    <input required type="text" name="name"
                                                        class="form-control mb-3" placeholder="Nama"
                                                        value=" {{ $to }}" readonly data-anim="zoom-in-up"
                                                        data-anim-delay="500">
                                                    <select required name="jumlah" id="rsvp_number"
                                                        class="form-select mb-3" data-anim="zoom-in-up"
                                                        data-anim-delay="500">
                                                    ...
                                                    <select required name="status" id="rsvp_status"
                                                        class="form-select mb-3" data-anim="zoom-in-up"
                                                        data-anim-delay="500">
                                                    ...
                                                    <div class="row justify-content-center">
                                                        <div class="col-md-6">
                                                            <button onclick="submitRsvp()"
                                                                class="btn btn-custom color-secondary w-100"
                                                                type="button" id="savebtn" data-anim="zoom-in-up"
                                                                data-anim-delay="500">Kirim</button>
                                                        </div>
                                                    </div>
                                                </form>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="guestbook_form_wrapper">
                                        <form id="submitWish" method="post" class="text-center">
                                            ...
                                            <div class="mb-3">
                                                <input type="text" name="name" value="{{ $to }}"
                                                    readonly placeholder="Name" class="form-control">
                                            </div>
                                            <div class="mb-3">
                                            </div>
                                            <div class="mb-3">
                                                <textarea required name="comment" id="comment" rows="5" class="form-control"
                                                    placeholder="Tulis pesan dan doa Anda"></textarea>
                                            </div>
                                            <button onclick="submitWish()"
                                                class="btn btn-custom color-secondary w-100" type="button"
                                                id="wishbtn" data-anim="zoom-in-up"
                                                data-anim-delay="500">Kirim</button>
    ...
    <!-- Modal -->
    <div class="modal fade show-maps" id="event2416" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="col-12 mt-3">
                        <div class="maps-element">
                            ...
                            <iframe class="maps-embed" width="100%" height="328" id="gmap_canvas"
                                data-src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=Hotel%20Shangri-La%20Jakarta&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                                frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                        </div>
                        <a class="btn btn-custom color__button__trans color-secondary mt-3"
                            href="https://www.google.com/maps/search/?api=1&query=Hotel%20Shangri-La%20Jakarta"
                            target="_blank">
                            Location
                        </a>
                    </div>
    ...
    <div class="modal fade show-maps" id="event7032" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-body text-center">
                    ...
                    <div class="col-12 mt-3">
                        <div class="maps-element">
                            ...
                            <iframe class="maps-embed" width="100%" height="328" id="gmap_canvas"
                                data-src="https://maps.google.com/maps?width=520&amp;height=400&amp;hl=en&amp;q=Griya%20Ardhya%20Garini,Jl.%20Rajawali%20Raya&amp;t=&amp;z=12&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                                frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                        </div>
                        <a class="btn btn-custom color__button__trans color-secondary mt-3"
                            href="https://www.google.com/maps/search/?api=1&query=Griya%20Ardhya%20Garini"
                            target="_blank">
                            Lokasi
                        </a>
                    </div>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/splidejs/3.6.11/js/splide.js"
        integrity="sha512-w59vitZ7hVdBIw8eTlp69j02OB/eo6cyyuvnMH1HzQYmMbrJWB5moOAsghwrAsN5KJEu4N9BZTDg4cOy54or+g=="
        crossorigin="anonymous" referrerpolicy="no-referrer"></script>
    ...
    <script
        src="{{ asset('assets/invitation/theme/assets/js/gift_registry_script.js?v=6b8f7f39b29ca238655923c1aed66ba770086fed') }}">
    </script>
    <script
        src="{{ asset('assets/invitation/theme/assets/js/colorpicker.min.js?v=5a09248438c634cf7d719879bcd4828dfee64f1f') }}">
    </script>
...
`;
    ...
    <script
        src="{{ asset('assets/invitation/theme/theme_79/assets/js/app.js?v=262981de74dd708fb8f8f51b5e4800ea92aee483') }}">
    </script>
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (`en` == 'en') {
                            $('.guestbook_form_wrapper').html(
                                "<p class='text-center'>Thank you, you have left a comment</p>");
                        } else {
                            $('.guestbook_form_wrapper').html(
                                "<p class='text-center'>Terima Kasih, Anda telah memberikan komentar</p>"
                            );
                    ...
                    error: function(data) {
                        ...
                        iziToast.error({
                            title: 'Gagal',
                            message: 'Pesan anda gagal ditambahkan. Silahkan mencoba kembali beberapa saat! ' +
